...
def main():
    try:
        ...
        env = WalkVecEnv(num_envs=NUM_ENVS, urdf_path=URDF_PATH, headless=True)
        # Add Normalization
        ...
        model = PPO(
            ...
            env,
            verbose=1,
            tensorboard_log="./tensorboard_logs_walk/",
            learning_rate=3e-4,
        ...
        checkpoint_callback = CheckpointCallback(save_freq=1000, save_path='./logs_walk/', name_prefix='walk_model')
        model.learn(total_timesteps=TOTAL_TIMESTEPS, callback=checkpoint_callback)
        print("Learn finished.")
        
        model.save("walk_ppo")
        env.save("walk_vecnormalize.pkl") # Save normalization stats
        print("Model saved.")
